...
#now a series of exp sfh with zform = 4,3,2.5,and 2
splot.plot([8.6,11.6],[models_z4['exp_dn4k'][0],models_z4['exp_dn4k'][0]],color='goldenrod',linestyle='--',linewidth=3,alpha=0.7,label='$z_f$=4.0',zorder=1)
splot.plot([8.6,11.6],[models_z3['exp_dn4k'][0],models_z3['exp_dn4k'][0]],color='MediumOrchid',linestyle='--',linewidth=3,alpha=0.7,label='$z_f$=3.0',zorder=1)
splot.plot([8.6,11.6],[models_z25['exp_dn4k'][0],models_z25['exp_dn4k'][0]],color='RoyalBlue',linestyle='--',linewidth=3,alpha=0.7,label='$z_f$=2.5',zorder=1)
splot.plot([8.6,11.6],[models_z2['exp_dn4k'][0],models_z2['exp_dn4k'][0]],color='Gray',linestyle='--',linewidth=3,alpha=0.7,label='$z_f$=2.0',zorder=1)
splot.plot([8.6,11.6],[models_z3['csf_dn4k'][0],models_z3['csf_dn4k'][0]],color='Gray',linestyle='-',linewidth=3,alpha=0.7,label='Constant SF',zorder=1)

#these are now fancy arrows
opt = {'head_width': 0.05, 'head_length': 0.05, 'width': 0.0075,
        'length_includes_head': True,'zorder':2}

#these are just white arrows to eliminate bleedthrough of the dotted lines
splot.add_patch(pylab.arrow(8.80,models_z3['exp_dn4k'][0],0,models_z3['exp_dn4k'][1]-models_z3['exp_dn4k'][0],color='White',alpha=1.0,**opt))
splot.add_patch(pylab.arrow(8.80,models_z3['exp_dn4k'][0],0,models_z3['exp_dn4k'][2]-models_z3['exp_dn4k'][0],color='White',alpha=1.0,**opt))

splot.add_patch(pylab.arrow(8.70,models_z4['exp_dn4k'][0],0,models_z4['exp_dn4k'][1]-models_z4['exp_dn4k'][0],color='White',alpha=1.0,**opt))
splot.add_patch(pylab.arrow(8.70,models_z4['exp_dn4k'][0],0,models_z4['exp_dn4k'][2]-models_z4['exp_dn4k'][0],color='White',alpha=1.0,**opt))

splot.add_patch(pylab.arrow(8.90,models_z25['exp_dn4k'][0],0,models_z25['exp_dn4k'][1]-models_z25['exp_dn4k'][0],color='White',alpha=1.0,**opt))
splot.add_patch(pylab.arrow(8.90,models_z25['exp_dn4k'][0],0,models_z25['exp_dn4k'][2]-models_z25['exp_dn4k'][0],color='White',alpha=1.0,**opt))
...
splot.add_patch(pylab.arrow(8.80,models_z3['exp_dn4k'][0],0,models_z3['exp_dn4k'][1]-models_z3['exp_dn4k'][0],color='MediumOrchid',alpha=1.0,**opt))
splot.add_patch(pylab.arrow(8.80,models_z3['exp_dn4k'][0],0,models_z3['exp_dn4k'][2]-models_z3['exp_dn4k'][0],color='MediumOrchid',alpha=1.0,**opt))

splot.add_patch(pylab.arrow(8.70,models_z4['exp_dn4k'][0],0,models_z4['exp_dn4k'][1]-models_z4['exp_dn4k'][0],color='goldenrod',alpha=1.0,**opt))
splot.add_patch(pylab.arrow(8.70,models_z4['exp_dn4k'][0],0,models_z4['exp_dn4k'][2]-models_z4['exp_dn4k'][0],color='goldenrod',alpha=1.0,**opt))

splot.add_patch(pylab.arrow(8.90,models_z25['exp_dn4k'][0],0,models_z25['exp_dn4k'][1]-models_z25['exp_dn4k'][0],color='RoyalBlue',alpha=1.0,**opt))
splot.add_patch(pylab.arrow(8.90,models_z25['exp_dn4k'][0],0,models_z25['exp_dn4k'][2]-models_z25['exp_dn4k'][0],color='RoyalBlue',alpha=1.0,**opt))
...
splot.text(8.72,0.07,'IRC 0218', family='serif',weight='ultralight',fontsize=16, color='k')
...
plt.ylim(0,2.7)
plt.xlim(8.65,11.6)
plt.savefig('cluster_d4kmass_williams', format='pdf',bbox_inches='tight')
plt.show()