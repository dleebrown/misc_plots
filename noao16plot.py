...
gammadorall=pd.read_csv(directory+'gdor_allfield.csv')
gdor2_teff=gammadorall['Te'].values

gammador3=pd.read_csv(directory+'gdor_3field.csv')
...
plt.savefig("/home/donald/Desktop/PYTHON/misc_data/noao16_plot",format='pdf',bbox_inches='tight')
